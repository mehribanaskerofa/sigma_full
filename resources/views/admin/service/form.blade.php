@extends('admin.layouts.admin',['title'=>'Section1'])


@section('content')
    <?php  $routeName='admin.service' ?><br>
    <div class="card">
        <div class="card-body">
                                   ...
                                   <div class="row">
                                       ...
                                       <div class="form-group col-12">
                                           ...
                                           <textarea id="summernote{{$index+3}}"  name="{{$lang}}[description]"
                                                     class="form-control">
                                           {{old("$lang.description",isset($model) ? ($model->translateOrDefault($lang)->description ?? '<li>Example</li>') : '<li>Example</li>')}}
                                           </textarea>
