@extends('admin.layouts.admin',['title'=>'Section appdev'])


@section('content')
    <?php  $routeName='admin.appdev' ?><br>
    <div class="card">
        <div class="card-body">
                                   ...
                                   <div class="row">
                                       ...
                                       <div class="form-group col-12">
                                           ...
                                           <textarea id="summernote{{$index}}"  name="{{$lang}}[description1]"
                                                     class="form-control">
                                           {{old("$lang.description1",isset($model) ? ($model->translateOrDefault($lang)->description1 ?? 'Description') : 'Description')}}
                                           </textarea>
                                       ...
                                       <div class="form-group col-12">
                                           ...
                                           <textarea id="summernote{{$index+3}}"  name="{{$lang}}[description2]"
                                                     class="form-control">
                                           {{old("$lang.description2",isset($model) ? ($model->translateOrDefault($lang)->description2 ?? 'Description') : 'Description')}}
                                           </textarea>
                                       ...
                                       <div class="form-group col-12">
                                           ...
                                           <textarea id="summernote{{$index+6}}"  name="{{$lang}}[description3]"
                                                     class="form-control">
                                           {{old("$lang.description3",isset($model) ? ($model->translateOrDefault($lang)->description3 ?? 'Description') : 'Description')}}
                                           </textarea>
                                       ...
                                       <div class="form-group col-12">
                                           ...
                                           <textarea id="summernote{{$index+9}}"  name="{{$lang}}[description4]"
                                                     class="form-control">
                                           {{old("$lang.description4",isset($model) ? ($model->translateOrDefault($lang)->description4 ?? 'Description') : 'Description')}}
                                           </textarea>
                                       ...
                                       <div class="form-group col-12">
                                           ...
                                           <textarea id="summernote{{$index+12}}"  name="{{$lang}}[description5]"
                                                     class="form-control">
                                           {{old("$lang.description5",isset($model) ? ($model->translateOrDefault($lang)->description5 ?? 'Description') : 'Description')}}
                                           </textarea>
                                       ...
                                       <div class="form-group col-12">
                                           ...
                                           <textarea id="summernote{{$index+15}}"  name="{{$lang}}[description6]"
                                                     class="form-control">
                                           {{old("$lang.description6",isset($model) ? ($model->translateOrDefault($lang)->description6 ?? 'Description') : 'Description')}}
                                           </textarea>
                                       ...
                                       <div class="form-group col-12">
                                           ...
                                           <textarea id="summernote{{$index+18}}"  name="{{$lang}}[description7]"
                                                     class="form-control">
                                           {{old("$lang.description7",isset($model) ? ($model->translateOrDefault($lang)->description7 ?? 'Description') : 'Description')}}
                                           </textarea>
