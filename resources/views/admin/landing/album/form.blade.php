@extends('admin.layouts.admin',['title'=>'Section Album'])


@section('content')
    <?php  $routeName='admin.album' ?><br>
    <div class="card">
        <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <select name="team" class="form-control"  >
                            @foreach( \App\Enums\Boards::cases() as $type)
                                <option value="{{$type->value}}"
                                    @selected(old('board',(isset($model) ? $model->board : null))==$type->value)
                                >{{$type->name}}</option>
                            @endforeach
