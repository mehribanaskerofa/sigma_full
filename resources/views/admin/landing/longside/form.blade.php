@extends('admin.layouts.admin',['title'=>'Section Long Side'])


@section('content')
    <?php  $routeName='admin.longside' ?><br>
    <div class="card">
        <div class="card-body">
                                ...
                                <div class="tab-pane fade {{$loop->first ? ' active show' : '' }}" id="title-{{$lang}}"
                                   ...
                                   <div class="row">
                                       ...
                                       <div class="form-group col-6">
                                           <label>Sub Name 1</label>
                                           <input type="text" placeholder="sub_name1 {{$lang}}" name="{{$lang}}[sub_name1]"
                                                  value="{{old("$lang.sub_name1",isset($model) ? ($model->translateOrDefault($lang)->sub_name1 ?? '') : '')}}"
                                                  class="form-control">
                                           @error("$lang.sub_name1")
                                           <span class="text-danger">{{$message}}</span>
                                           @enderror
                                       </div>
                                       <div class="form-group col-6">
                                           <label>Sub Name 2</label>
                                           <input type="text" placeholder="sub_name2 {{$lang}}" name="{{$lang}}[sub_name2]"
                                                  value="{{old("$lang.sub_name2",isset($model) ? ($model->translateOrDefault($lang)->sub_name2 ?? '') : '')}}"
                                                  class="form-control">
                                           @error("$lang.sub_name2")
                                           <span class="text-danger">{{$message}}</span>
                                           @enderror
                                       </div>
