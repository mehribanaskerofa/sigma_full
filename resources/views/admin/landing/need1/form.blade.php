@extends('admin.layouts.admin',['title'=>'Section Need 1'])


@section('content')
    <?php  $routeName='admin.need1' ?><br>
    <div class="card">
        <div class="card-body">
                                ...
                                <div class="tab-pane fade {{$loop->first ? ' active show' : '' }}" id="title-{{$lang}}"
                                   ...
                                   <div class="row">
                                       ...
                                       <div class="form-group col-4">
                                           ...
                                           <input type="text" placeholder="sub_title1 {{$lang}}" name="{{$lang}}[sub_title1]"
                                       ...
                                       <div class="form-group col-4">
                                           ...
                                           <input type="text" placeholder="sub_title2 {{$lang}}" name="{{$lang}}[sub_title2]"
                                       ...
                                       <div class="form-group col-4">
                                           ...
                                           <input type="text" placeholder="sub_title3 {{$lang}}" name="{{$lang}}[sub_title3]"
                                       ...
                                       <div class="form-group col-4">
                                           ...
                                           <input type="text" placeholder="sub_title4 {{$lang}}" name="{{$lang}}[sub_title4]"
                                                  value="{{old("$lang.sub_title4",isset($model) ? ($model->translateOrDefault($lang)->sub_title4 ?? '') : '')}}"
                                                  class="form-control">
                                           @error("$lang.sub_title4")
                                           <span class="text-danger">{{$message}}</span>
                                           @enderror
                                       </div>
