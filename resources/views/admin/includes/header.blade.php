...
{{--            <img src="{{asset('_assets/global_assets/images/logo_light.png')}}" class="d-none d-sm-block" alt="">--}}
{{--            <img src="{{asset('_assets/global_assets/images/logo_icon_light.png')}}" class="d-sm-none" alt="">--}}
{{--        </a>--}}
{{--    </div>--}}
...
{{--                            <li class="media">--}}
{{--                                <div class="mr-3">--}}
{{--                                    <img src="{{asset('_assets/global_assets/images/placeholders/placeholder.jpg')}}" width="36" height="36" class="rounded-circle" alt="">--}}
{{--                                </div>--}}
{{--                                <div class="media-body">--}}
...
{{--                <img src="{{asset('_assets/global_assets/images/placeholders/placeholder.jpg')}}" class="rounded-pill mr-lg-2" height="34" alt="">--}}
