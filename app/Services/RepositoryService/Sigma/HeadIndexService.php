...
class HeadIndexService
{
    public function __construct(protected HeadIndexRepository $repository)
    {
    }
    ...
    public function store($request)
    {
        ...
        $model= $this->repository->save($data,new HeadIndex());
    ...
    {
        return Cache::rememberForever('head_indexs',
            function (){
