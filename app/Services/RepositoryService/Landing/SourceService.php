...
use App\Repositories\Landing\SourceRepository;
...
class SourceService
{
    ...
    public function store($request)
    {
        ...
        $data['image']=$this->fileUploadService
            ->uploadFile($request->image,'source_images');


        $model= $this->repository->save($data,new Source());
    ...
    public function update($request,$model)
    {
        ...
        if($request->has('image')){
            $data['image']=$this->fileUploadService
                ->replaceFile($request->image,$model->image,'source_images');
        }
    ...
    {
        return Cache::rememberForever('source',
            function (){
