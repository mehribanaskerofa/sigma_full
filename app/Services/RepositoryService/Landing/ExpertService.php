...
use App\Repositories\Landing\ExpertRepository;
...
class ExpertService
{
    public function __construct(protected ExpertRepository $repository,
    ...
    public function store($request)
    {
        ...
        $data['image']=$this->fileUploadService
            ->uploadFile($request->image,'expert_images');


        $model= $this->repository->save($data,new Expert());
    ...
    public function update($request,$model)
    {
        ...
        if($request->has('image')){
            $data['image']=$this->fileUploadService
                ->replaceFile($request->image,$model->image,'expert_images');
        }
    ...
    {
        return Cache::rememberForever('expert',
            function (){
