                    ...
                    price.months.filter(function (month) {
                       if (month.month === parseInt($_month)) {
                            ...
                            // console.log(homePrice)
                                ...
                                // console.log(homePrice,formatNumber($_initialPrice), formatNumber((($_homeFixPrice - $_initialPrice)/ selectedMonth.month).toFixed(2)))
                            }
                        }
                    });
                }
...
function initialPaymet() {
    ...
    $_percent = $("#percent").val();
    $_month = $("#month").val();
    console.log(_room,_area,$_percent);
