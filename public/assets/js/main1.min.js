...
const form = document.querySelector('.form-section.page-section');
...
$(document).ready(function() {
    $("#contact-btn").on('submit', function(event) {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.success) {
                    // If validation is successful, redirect or display a success message
                    window.location = data.redirect; // Redirect to a success page
                } else {
                    // If validation fails, display errors under input fields
    ...
    // Function to display validation errors under input fields
    function displayErrors(errors) {
    for (const field in errors) {
    const errorField = $(`[name="${field}"]`);
    const errorContainer = $(`#${field}Error`);

    if (errorField.length > 0 && errorContainer.length > 0) {
